...
Az alkalmazás feladata, hogy az adatbázisban lévő növénykből egy tetszés szerinti összeállítást lehet készíteni a terület adottságai és a növények szükségletei alapján.
...
- [A User Story (adminisztrátori szerepkör) itt érhető el.](https://github.com/FeketeO/kertemberkem)

- [A kiegészítő anyagok itt érhetők el: [comment]: <> (Kiegészítés később)
